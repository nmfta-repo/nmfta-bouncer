...
public class WhitelistIPAddressesController extends BaseController {
     ...
     * @return The singleton instance of the WhitelistIPAddressesController class 
     */
    public static WhitelistIPAddressesController getInstance() {
        if (null == instance) {
    ...
    private HttpRequest _buildRemoveRequest(
        ...
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/v1.1/whitelists/ipaddresses/{entry_id}/delete");
    ...
    private HttpRequest _buildUpdateRequest(
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/v1.1/whitelists/ipaddresses/{entry_id}/update");
    ...
    private HttpRequest _buildCreateRequest(
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/v1.1/whitelists/ipaddresses/create");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);
    ...
    private HttpRequest _buildGetDetailsRequest(
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/v1.1/whitelists/ipaddresses/{entry_id}");
    ...
    private HttpRequest _buildListRequest() throws IOException, APIException {
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/v1.1/whitelists/ipaddresses");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);
    ...
    private HttpRequest _buildSearchRequest(
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/v1.1/whitelists/ipaddresses/filter/{search_filter}");
