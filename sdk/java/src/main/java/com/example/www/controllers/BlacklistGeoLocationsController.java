...
public class BlacklistGeoLocationsController extends BaseController {
     ...
     * @return The singleton instance of the BlacklistGeoLocationsController class 
     */
    public static BlacklistGeoLocationsController getInstance() {
        if (null == instance) {
    ...
    private HttpRequest _buildRemoveRequest(
        ...
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/v1.1/blacklists/geolocations/{entry_id}/delete");
    ...
    private HttpRequest _buildCreateRequest(
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/v1.1/blacklists/geolocations/create");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);
    ...
    private HttpRequest _buildUpdateRequest(
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/v1.1/blacklists/geolocations/{entry_id}/update");
    ...
    private HttpRequest _buildListRequest() throws IOException, APIException {
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/v1.1/blacklists/geolocations");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);
    ...
    private HttpRequest _buildGetDetailsRequest(
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri + "/v1.1/blacklists/geolocations/{entry_id}");
