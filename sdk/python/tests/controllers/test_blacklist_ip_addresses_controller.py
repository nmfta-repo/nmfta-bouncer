...
class BlacklistIPAddressesControllerTests(ControllerTestBase):

    @classmethod
    def setUpClass(cls):
        super(BlacklistIPAddressesControllerTests, cls).setUpClass()
        cls.controller = cls.api_client.blacklist_ip_addresses
