...
class BlacklistIPAddressesController(BaseController):
    ...
    def update(self,
                entry_id,
                body):
        """Does a PUT request to /v1.1/blacklists/ipaddresses/{entry_id}/update.
        ...
        # Prepare query URL
        _url_path = '/v1.1/blacklists/ipaddresses/{entry_id}/update'
    ...
    def remove(self,
                entry_id,
                body):
        """Does a DELETE request to /v1.1/blacklists/ipaddresses/{entry_id}/delete.
        ...
        # Prepare query URL
        _url_path = '/v1.1/blacklists/ipaddresses/{entry_id}/delete'
        _url_path = APIHelper.append_url_with_template_parameters(_url_path, { 
            'entry_id': entry_id
        })
        _query_builder = Configuration.get_base_uri()
    ...
    def create(self,
                body):
        """Does a POST request to /v1.1/blacklists/ipaddresses/create.
        ...
        # Prepare query URL
        _url_path = '/v1.1/blacklists/ipaddresses/create'
        _query_builder = Configuration.get_base_uri()
        _query_builder += _url_path
        _query_url = APIHelper.clean_url(_query_builder)
    ...
    def list(self):
        """Does a GET request to /v1.1/blacklists/ipaddresses.
        ...
        # Prepare query URL
        _url_path = '/v1.1/blacklists/ipaddresses'
        _query_builder = Configuration.get_base_uri()
        _query_builder += _url_path
        _query_url = APIHelper.clean_url(_query_builder)
