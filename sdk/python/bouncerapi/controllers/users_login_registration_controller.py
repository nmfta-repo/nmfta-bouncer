...
from bouncerapi.models.login_to_bouncer_api_response import LoginToBouncerAPIResponse
from bouncerapi.models.register_new_user_response import RegisterNewUserResponse
from bouncerapi.exceptions.return_exception import ReturnException

class UsersLoginRegistrationController(BaseController):
    ...
    def login_to_bouncer_api(self,
                             body):
        """Does a POST request to /v1.1/login.

        Authenticate to this Bouncer instance.

        Args:
            body (LoginToBouncerAPIRequest): TODO: type description here.
                Example: 

        Returns:
            LoginToBouncerAPIResponse: Response from the API. 
        ...
        return APIHelper.json_deserialize(_context.response.raw_body, LoginToBouncerAPIResponse.from_dictionary)
    ...
    def register_new_user(self,
        ...
        # Return appropriate type
        return APIHelper.json_deserialize(_context.response.raw_body, RegisterNewUserResponse.from_dictionary)
