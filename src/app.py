...
api.add_resource(firewall.IpList, "/whitelists/ipaddresses", resource_class_kwargs={"ltype":"wl"}, endpoint="wll")
...
api.add_resource(firewall.IpList, "/blacklists/create", resource_class_kwargs={"ltype":"bl"}, endpoint="bll")
